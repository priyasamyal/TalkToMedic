...
class ApptMedicalHistory extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    viewMedicalHistoryByRmp = () => {
        var param = {
            ...
            // iFamilyMemberId: "1"
            iFamilyMemberId: this.props.rmp_prescription_data.data.iFamilyMemberId
        }
        console.log(param)
        setTimeout(() => {
            this.setState({
        ...
        return (
            <Container>
                ...
                <HeaderComponent
                    ...
                    clickHandler={this.navigator} title={constant.page_titles.MEDICAL_HISTORY}></HeaderComponent>
                        ...
                        {this.state.history.length > 0 && (
                            <View style={{ flex: 1, }}>
                                <View style={[styles.numberInputContainerRow, { fontSize: 20 }]}>
                                    <Picker
                                        enabled={this.props.rmp_prescription_data.from == "account" ? true : false}
                                        note
...
export default connect(mapStateToProps, {})(ApptMedicalHistory);
