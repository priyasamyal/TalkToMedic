...
class Camera extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            canSkip: true,
            header: true,
            maxFileCount: this.props.maxCount ? this.props.maxCount : 1,
                    ...
                    switch (result) {
                        ...
                        case RESULTS.GRANTED:
                            ...
                            ImagePicker.openPicker({
                                ...
                                includeBase64: true,
                                multiple: true,
                                maxFiles: this.state.maxFileCount,
                                ...
                                image => {
                                    ...
                                    if (Array.isArray(image)) {
                                        image.forEach(element => {
                                            imagesData.push({
                                                uri: 'data:image/jpeg;base64,' + element.data,
                                                path: element.path,
                                                full_object: element
                                            })
                                        });
                                    ...
                                    this.props.getImageUri("camera_click", imagesData);
